...
class Document extends Node {
     ...
     */
    get cookie() {
        return CookieStringUtility.cookiesToString(__classPrivateFieldGet(this, _Document_browserFrame, "f").page.context.cookieContainer.getCookies(this[PropertySymbol.ownerWindow].location, true));
    }
    /**
    ...
    createElementNS(namespaceURI, qualifiedName, options) {
        ...
        if (customElement) {
            const element = NodeFactory.createNode(this, customElement.elementClass);
